...
<div class="container mx-auto mt-10">
    <h2 class="text-4xl font-semibold text-gray-700 mb-8">Edit User</h2>
    <form action="{{route('admin.handle-edit-user', $user->id)}}" method="POST" enctype="multipart/form-data"
        ...
        <div class="mb-4">
            ...
            <input
                ...
                type="text" name="role" id="role" value="{{$user->role}}">
        </div>
