...
<head>
    ...
    <title>Royal Terroir - Search Results</title>
...
<body class="font-['Laila']">
    @include('navigation')
    @if($wines->isEmpty())
        <p class="h-screen flex items-center justify-center text-3xl font-bold text-red-500">No results found.</p>
    @else
        <ul>
            <section class="py-16">
                <div class="container mx-auto px-4">
                    <h2 class="text-4xl font-bold mb-10 text-center">Search Result for {{$query}}</h2>
