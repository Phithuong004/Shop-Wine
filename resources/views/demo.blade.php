...
<section class="py-16 bg-white">
    <div class="wpb">
        ...
        <div class="img-wrapper z-0">
            <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_features1.jpg"
                alt="">
        </div>
        ...
        <div class="img-wrapper z-0">
            <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_features3.jpg"
                alt="">
        </div>
        <div class="border-solid border " id="wpb_wrapper">
        ...
        <!-- item 3 -->
        <div class="img-wrapper z-0">
            <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_features2.jpg"
                alt="">
        </div>
        <div class="border-solid border " id="wpb_wrapper">
                ...
                <div class="overflow-hidden relative h-56 rounded-lg sm:h-64 xl:h-80 2xl:h-96">
                    ...
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <span
                            ...
                            Slide</span>
                        <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_slider2.jpg"
                            class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                            alt="...">
                    </div>
                    <!-- Item 2 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_slider3.jpg"
                            class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                            alt="...">
                    </div>
                    <!-- Item 3 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_slider4.jpg"
                            class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                            alt="...">
                    </div>
                    <!-- Item 4 -->
                    <div class="hidden duration-700 ease-in-out" data-carousel-item>
                        <img src="https://templatebundle.net/wp/moto/netw5/luxury-wine/wp-content/uploads/sites/8/2019/04/lw_slider1.jpg"
                            class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2"
                            alt="...">
                    </div>
                </div>
...
<!-- story section -->
<section class="py-16 bg-white container">
    <div class="container mx-auto px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 mt-8 font-mono">
            <div class="pl-28">
