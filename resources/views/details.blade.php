    ...
    <div class="relative">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white">
            <div class="grid grid-cols-2 lg:space-x-60 min-[300px]:space-x-14">
                ...
                <div class="flex-1 text-2xl font-bold text-white w-full bg-gray-50 bg-opacity-25 rounded-full text-center">
    ...
    <div class="container px-5 py-24 mx-auto flex justify-center">
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <p class="leading-relaxed">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis, dicta ea ipsam maiores minima nesciunt non numquam quas? Adipisci atque blanditiis consequatur cumque dolor itaque neque optio quae quam qui quibusdam quo sequi, voluptas! Architecto dignissimos iste sed. Beatae commodi, cum deserunt earum esse est fuga illo itaque iusto magni perspiciatis, placeat provident quo reprehenderit temporibus tenetur voluptate voluptatibus. Aliquam aliquid amet beatae, corporis culpa doloremque ducimus, et excepturi harum impedit inventore laborum necessitatibus nihil quod reiciendis repellat rerum sapiente sequi tenetur totam voluptas voluptate voluptates? Cumque, cupiditate distinctio doloribus exercitationem expedita, harum hic neque quas quo reiciendis sequi ullam!</p>
                <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                </div>
                <div class="flex">
                    <input type="text" name="" id="" value="1" class="border border-gray-900 rounded py-2 px-3 w-20">
                    <button
                        class="flex ml-auto text-white bg-[#b5a46d] border-0 py-2 px-6 focus:outline-none hover:bg-gray-900 rounded transition-all duration-300 font-bold text-center" style="border-radius: 20px 0">
                        Add to Cart
                    </button>
                </div>
            </div>
